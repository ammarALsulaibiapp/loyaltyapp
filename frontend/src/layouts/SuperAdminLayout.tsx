      ...
      <div className="p-5 border-b border-slate-800/80 relative z-10">
        <div className="flex items-center gap-3">
          <div className="relative group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-purple-500 via-pink-500 to-red-500 p-0.5 shadow-lg shadow-purple-500/25 group-hover:scale-105 transition-transform duration-300">
            ...
            <span className="absolute -bottom-1 -right-1 w-3 h-3 bg-purple-500 border-2 border-slate-900 rounded-full animate-pulse" />
          </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className="px-1.5 py-0.5 rounded text-[9px] font-extrabold bg-purple-500/25 text-purple-300 border border-purple-500/40 uppercase tracking-wider">
                SUPER ADMIN
              </span>
            </div>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  clsx(
                    ...
                    isActive
                      ? 'bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 text-white shadow-lg shadow-purple-500/25 font-semibold scale-[1.02]'
      ...
      <div className="p-3 border-t border-slate-800/80 bg-slate-950/60 backdrop-blur-md relative z-10 space-y-3">
        ...
        <div className="flex items-center gap-3 p-2.5 rounded-xl bg-slate-900/80 border border-slate-800/80">
          <div className="relative">
            <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-purple-500 to-pink-500 p-0.5 shadow-md">
